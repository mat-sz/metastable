...
def add_training_arguments(parser: argparse.ArgumentParser, support_dreambooth: bool):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="using .json instead of args to pass hyperparameter / ハイパーパラメータを引数ではなく.jsonファイルで渡す",
    )
    parser.add_argument(
        "--output_config", action="store_true", help="output command line args to given .json file / 引数を.jsonファイルに出力する"
    )
